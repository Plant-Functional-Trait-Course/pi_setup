...
used_seeds <- tibble::tribble(~Campaign, ~Country, ~Year, ~seed,
                "PFTC3 & Puna", "Peru", 2018, 1,
                "PFTC4", "Svalbard", 2018, 32, 
                "PFTC5", "Peru", 2020, 6) 
knitr::kable(used_seeds)
```
...
Plug in the scanner and run the `scan leaf` desktop icon and wait for `xsane` to open. Set 
...
Download and install the VNC viewer from [https://www.realvnc.com/en/connect/download/viewer/](https://www.realvnc.com/en/connect/download/viewer/)
...
Take empty SD card. If there is still data it needs to be erased/formatted. Check out how: https://www.raspberrypi.org/documentation/installation/sdxc_formatting.md
